...
"「好きなもの？ふむ、強いて言うなら、水銀かな。永劫不滅を象徴するかのようなその在り方！まさしく、朕に相応しい美しさであろうよ」",
"「まこと度し難き衆生よな」",
...
var ereshkigal = [
"「ちょ、ちょっと待ってぇ！まだ心の準備がぁ…って、もう見られてるぅー！そ、そうよ……これが今回用に新調した礼服。地上に出かける用の普段着なのだわ。こういうの着慣れないのだけど……似合っていたら嬉しいわ」",
"「いい度胸ね、気に入ったわ」",
"「いいのだわ、冥界まで連れて行ってあげる！」",
"「いいわ、地の底まで落としてあげる！」",
"「はーいそこ、ベッドでぐうたらしない！イベントが無くても最低限の訓練はしないとダメよ。地道な積み重ねが最後にはみんなを助けるんだからね？」",
"「マスターとサーヴァントである以前に、人間と女神であることを忘れないように。貴方が人理に反する行いをするようなら、容赦なく神罰下すからね？」",
...
"「レベルマになってもスキルマじゃないとフレンドさんは使ってくれないという現実・・・」",
...
"「マシュ ！」",
      ...
      /*北斎*/
      robot.hear(/fgo|北斎|栄|葛飾|はい|疲れた|いいえ|帰りたい|たこ|タコ|fgoやりたい|最新情報を教えて/i,
            function(msg) {
     ...
     /*ゴルドルフ*/
      robot.hear(/fgo|ゴルドルフ|疲れた|帰りたい|はい|ムジーク|お腹すいた|所長|fgoやりたい|最新情報を教えて/i,
            function(msg) {
      ...
      /*朕*/
      robot.hear(/fgo|始皇帝|朕|エンペラー|ラスト|疲れた|帰りたい|はい|中華|皇帝|fgoやりたい|最新情報を教えて/i,
            function(msg) {
      ...
      /*マンドリカルド*/
      robot.hear(/fgo|マンドリカルド|疲れた|帰りたい|はい|マイフレンド|友|とも|は|が|に|fgoやりたい|最新情報を教えて/i,
            function(msg) {
